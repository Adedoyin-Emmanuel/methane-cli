...
import * as userReadConfig from "./read-user-config.js";
import * as userWriteConfig from "./write-user-config.js";
...
const configurePackage = () => {
  program
    ...
    .option(
      "-t, --template " + colors.bold(colors.white("<template>")),
      "Set the default template (jsx or tsx)"
    )
    .option(
      "-c, --component " + colors.bold(colors.white("<component>")),
      "Set the default component type (arrow or functional)"
    )
    .option(
      "-p, --page " + colors.bold(colors.white("<page>")),
      "Set the default page type (arrow or functional)"
    )
    .option(
      "-r, --register " + colors.bold(colors.white("<boolean>")),
      "Set the default registration of pages in the App.jsx or App.tsx file (true or false)"
    )
    .option(
      "-st, --stylesheetType " + colors.bold(colors.white("<style>")),
      "Set the default style type (css or scss)"
    )
    .option(
      "-gs, --generateStylesheet " + colors.bold(colors.white("<boolean>")),
      "Generates a stylesheet file for the Component and Pages. (true or false)"
    )
    .option(
      "-gf, --generateFolder " + colors.bold(colors.white("<boolean>")),
