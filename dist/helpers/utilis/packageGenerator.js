...
const packageGenerator = () => {
    program
        ...
        .option("-ndp, --next-dynamic-page " + colors.bold(colors.white("<name>")), "Generates a NextJs dynamic page file.")
        ...
        const { component, page, serviceWorker, nextComponent, nextPage, nextDynamicPage, componentType } = name;
