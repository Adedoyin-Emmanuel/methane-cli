        ...
        files.forEach((file) => {
            ...
            if (stats.isDirectory() && file !== "node_modules") {
                ...
                if (!fileContents.includes(importStatement)) {
                    ...
                    console.log(colors.bold(colors.cyan(`Successfully injected import statement into ${filePath}`)));
                }
                else {
                    console.log(colors.bold(colors.red(`Import statement already exists in ${filePath}`)));
                }
            }
        });
    };
